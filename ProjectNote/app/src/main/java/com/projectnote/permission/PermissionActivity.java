package com.projectnote.permission;
...
import com.projectnote.MainActivity;
        ...
        public void handleMessage(@NonNull Message msg) {
            switch (msg.what) {
                case 1: {
                    ...
                    Toast.makeText(PermissionActivity.this, tip, Toast.LENGTH_SHORT).show();
                }
            }
        }
    };
    private Button btnApplySingle;
    private Button btnApplyMultiple;
    @Override
        ...
        AlertDialog dialog = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        String[] sList=pmList.toArray(new String[0]);
                        //重新申请该权限
                        ActivityCompat.requestPermissions(PermissionActivity.this,sList,10000);
                    }
                })
                .create();
        dialog.show();
