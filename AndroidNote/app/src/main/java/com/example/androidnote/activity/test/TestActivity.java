package com.example.androidnote.activity.test;
...
import com.example.androidnote.tts.SynthActivity;
...
public class TestActivity extends BaseActivity implements View.OnClickListener, EventListener {
    ...
    private void initView() {
        ...
        ttsBtn = findViewById(R.id.btn_tts);
    ...
    private void testTTS() {
        Intent intent = new Intent(this, SynthActivity.class);
